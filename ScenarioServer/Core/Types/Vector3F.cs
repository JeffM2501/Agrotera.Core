...
namespace Core.Types
{
	public class Vector3F
	{
		...
		public static readonly Vector3F Invalid = new Vector3F(float.MinValue, float.MaxValue, float.MaxValue);
		...
		public static Vector3F operator -(Vector3D v1, Vector3F v2)
		{
			return new Vector3F((float)(v1.X - v2.X), (float)(v1.Y - v2.Y), (float)(v1.Z - v2.Z));
		}
		public static Vector3F operator -(Vector3F v1, Vector3D v2)
		{
			return new Vector3F((float)(v1.X - v2.X), (float)(v1.Y - v2.Y), (float)(v1.Z - v2.Z));
		}

		public static float DotProduct(Vector3F p1, Vector3F p2)
		{
		...
		public static Vector3F FromRelativeDobules(Vector3D p1, Vector3D o)
		{
		...
		public static bool NearEqual(Vector3F p1, Vector3F p2, float tolerance)
		{
		...
		public static bool TryParse(string text, out Vector3F vec)
		{
			...
			return float.TryParse(bits[0], out vec.X) && float.TryParse(bits[1], out vec.Y) && float.TryParse(bits[2], out vec.Z);
		}
